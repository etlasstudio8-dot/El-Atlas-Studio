...
exports.getTeamMemberById = async (req, res) => {
  try {
    const member = await TeamMember.findById(req.params.id).populate('createdBy', 'name email');
...
exports.updateTeamMember = async (req, res) => {
  try {
    ...
    member = await TeamMember.findByIdAndUpdate(req.params.id, req.body, { new: true });
